          ...
          <div class="card-body py-8 px-lg-5">
            ...
            <div class="hstack gap-3">
              <a href="javascript:void(0)"
                ...
                In <img src="./template/assets/images/svgs/icon-google.svg" alt="google" class="img-fluid"></a>
              <a href="javascript:void(0)"
                class="btn btn-outline-light bg-white px-3 py-2 fs-4 text-dark w-50 fw-medium hstack gap-2 lh-lg justify-content-center">Sign
                In <img src="./template/assets/images/svgs/icon-github.svg" alt="google" class="img-fluid"></a>
            </div>
