    ...
    <section class="login-section">
      <div class="login-container">
        ...
        <div class="login-info">
          ...
          <p class="tagline">Kelola koperasi Anda dengan mudah dan efisien melalui platform digital kami.</p>
          
          <ul class="feature-list">
            <li>
              <i class="fas fa-chart-line"></i>
              <span>Manajemen Simpanan & Pinjaman</span>
            </li>
            <li>
          ...
          <div class="sign-in card">
            <div class="card-body">
              ...
              <div class="logo-section">
                ...
                <div class="logo-subtitle">Sistem Manajemen Digital</div>
              </div>
              ...
              <div class="form-footer">
                ...
                <p>
                  Belum memiliki akun? <a href="regristasi.php">Daftar di sini</a>
                </p>
              </div>
            </div>
          </div>
